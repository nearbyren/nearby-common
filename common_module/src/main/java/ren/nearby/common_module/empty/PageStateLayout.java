...
import ren.nearby.common_module.empty.utils.PageState;
import ren.nearby.common_module.empty.widget.MaterialProgress;
import ren.nearby.common_module.empty.widget.RippleView;
...
public class PageStateLayout extends FrameLayout implements PageStateListener {
    ...
    private View initLoadingView() {
        View loadingView = LayoutInflater.from(mContext).inflate(R.layout.empty_loading, null, false);
...
//        );
    ...
    private View initErrorView() {
        View errorView = LayoutInflater.from(mContext).inflate(R.layout.empty_error, null, false);
        LayoutParams params = new LayoutParams(
    ...
    private View initEmptyView() {
        View emptyView = LayoutInflater.from(mContext).inflate(R.layout.empty_empty, null, false);
        LayoutParams params = new LayoutParams(
                LayoutParams.WRAP_CONTENT,
                LayoutParams.WRAP_CONTENT
        );
