 ...
 * @Date：2019/9/28 0028 上午 10:10
 * 修改人：Administrator
 * 修改时间：2019/9/28 0028 上午 10:10
 * 修改备注：
 */
public class PermissionPageUtils {
    private Context mContext;
    //自己的项目包名
    private String packageName="www.nearby.ren";
    public static final int RESULT_PERMISSION_CODE = 0x01001;
    public static final int REQUEST_PERMISSION_CODE = 0x01002;
    ...
    public void jumpPermissionPage() {
        ...
        Logger.d( "jumpPermissionPage --- name : " + name);
        switch (name) {
            case "HUAWEI":
                goHuaWeiMainager();
                break;
    ...
    private void goHuaWeiMainager() {
        try {
            ...
            intent.setComponent(comp);
//            mContext.startActivity(intent);
            ((Activity) mContext).startActivityForResult(intent, REQUEST_PERMISSION_CODE);
        } catch (Exception e) {
            Toast.makeText(mContext, "跳转失败", Toast.LENGTH_LONG).show();
            e.printStackTrace();
            goIntentSetting();
    ...
    private void goXiaoMiMainager() {
        ...
        Logger.d( "goMiaoMiMainager --- rom : "+rom);
